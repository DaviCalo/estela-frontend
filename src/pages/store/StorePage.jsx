  ...
  return (
    <div>
      ...
      <GameCarousel
        ...
        handleWishlistToggle={onGetWislist}
      />
          <div className="store-page-benefit-wrapper">
        <div className="store-page-benefits-container">
            <div className="store-page-benefit-item">
              <div className="store-page-benefit-icon-target"></div>
              <p className="store-page-benefit-text">Explore e encontre seu próximo desafio</p>
            </div>
            <div className="store-page-benefit-divider"></div>
            <div className="store-page-benefit-item">
              <div className="store-page-benefit-icon-megaphone"></div>
              <p className="store-page-benefit-text">Veja os mais novos lançamentos</p>
            </div>
            <div className="store-page-benefit-divider"></div>
            <div className="store-page-benefit-item">
              <div className="store-page-benefit-icon-lock"></div>
              <p className="store-page-benefit-text">Mantenha seus jogos catalogados e seguros</p>
            </div>
          </div>
          </div>
